(() => {
  ...
  var require_CyrillicToTranslit = __commonJS({
    "node_modules/cyrillic-to-translit-js/CyrillicToTranslit.js"(exports, module) {
      "use strict";
      module.exports = /* @__PURE__ */ __name(function cyrillicToTranslit2(config) {
  ...
  var Nt = /* @__PURE__ */ __name((i, t, l) => t in i ? jt(i, t, { enumerable: true, configurable: true, writable: true, value: l }) : i[t] = l, "Nt");
  ...
  var a = /* @__PURE__ */ __name((i, t) => jt(i, "name", { value: t, configurable: true }), "a");
  var Qi = /* @__PURE__ */ __name((i, t) => {
    for (var l in t)
      jt(i, l, { get: t[l], enumerable: true });
  }, "Qi");
  var b = /* @__PURE__ */ __name((i, t, l) => (Nt(i, typeof t != "symbol" ? t + "" : t, l), l), "b");
  var or = /* @__PURE__ */ __name((i, t, l) => new Promise((w, U) => {
  ...
  var Y = /* @__PURE__ */ __name(class extends Map {
    constructor(...l) {
      super(...l);
      b(this, "_lastID");
      this._lastID = 0;
...
`), font: U.fonts[on], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  var tasks = [
    ...
    "PAO-4564 - \u0417\u0430\u043A\u0435\u0448\u0438\u0440\u043E\u0432\u0430\u0442\u044C\xA0getProductsMeasurementSettings \u0432 \u0433\u0440\u0443\u043F\u043F\u0438\u043D\u0433\u0435",
  ...
  // src/feature.js
  var import_cyrillic_to_translit_js = __toModule(require_CyrillicToTranslit());
  var cyrillicToTranslit = new import_cyrillic_to_translit_js.default();
  ...
  var createService = /* @__PURE__ */ __name((k2, state) => {
    ...
    service.onDraw(() => {
      ...
      const nameTextSize = k2.formatText(nameOptions);
      k2.drawText(__spreadProps(__spreadValues({}, nameOptions), {
        pos: k2.vec2(Math.floor(service.width / 2 - nameTextSize.width / 2), service.height + 10),
        color: k2.rgb(255, 255, 255)
      }));
      ...
      k2.onCollide("service", "player", function(service, player) {
        const disposeUpdate = service.onUpdate(() => {
          if (service.isColliding(player)) {
            service.state.progress = Math.min(1, service.state.progress + 0.2 * k2.dt());
